...
df_2021 <- read_csv(file.path(path_data, "YMR_AllSTICsCleaned_20210716-20211231.csv"))
df_2022 <- read_csv(file.path(path_data, "YMR_AllSTICsCleaned_20220101-20221231.csv"))
...
ggsave(file.path(path_data, "YMR_AllSTICsCleaned_SummaryPlots.png"),
